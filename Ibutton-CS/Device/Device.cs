...
namespace Ibutton_CS.DeviceFunctions
{
    public static class Device
    {
        ...
        private static void ReadPageCRC(PortAdapter portAdapter, int page, bool readContinue, byte[] readBuffer, int offset, byte[] extraInfo)
        {
            ...
            int address = page * MemoryRegister.pageLength + MemoryRegister.startPhysicalAddress;
            ...
            rawBuffer = new byte[MemoryRegister.pageLength + 3];
